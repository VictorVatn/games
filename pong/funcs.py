...
def key_getter(y_vel, player1_vel, player2_vel):
    p2_actions = 0
    p1_actions = 0
...
def game_loop():
    ...
    while run:
        ...
        y_vel, player1_vel, player2_vel = key_getter(y_vel, player1_vel, player2_vel)
        ...
        if over:
            ...
            p2.x = display_width - player_width
            p2.y = display_height / 2 - player_height / 2

            p1.x = 0
            p1.y = display_height / 2 - player_height / 2

            ball.x = display_width // 2
            ball.y = display_height // 2
            game_over(ball, p1, p2)
